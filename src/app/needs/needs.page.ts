...
const powerA_string = "11043333b434"
...
export class NeedsPage implements OnInit, OnDestroy {
  ...
  onTemperatureChange(buffer: ArrayBuffer) {
    ...
    if (this.resultStringArray[8] == '91' &&
      this.resultStringArray[10] == '33' &&
      this.resultStringArray[11] == '33' &&
      this.resultStringArray[12] == 'B4' &&
      this.resultStringArray[9] == '34') {

      this.ngZone.run(() => {
        this.Maxneeds = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
        ...
        this.Maxneeds_T = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 6], '33') +
