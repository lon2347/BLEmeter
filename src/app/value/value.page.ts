...
const curve_string = "110A32344439453333353C57";
const voltageA_string = "110433343435"

const voltageB_string = "110433353435"

const voltageC_string = "110433363435"
...
export class ValuePage implements OnInit, OnDestroy {
  ...
  onTemperatureChange(buffer: ArrayBuffer) {
    ...
    if (this.resultStringArray[this.resultStringArray.length - 7] == '34' && this.resultStringArray[this.resultStringArray.length - 10] == '91') {

      this.ngZone.run(() => {
        this.voltage_A = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
      ...
      console.log('ywd:' + this.voltage_A);
    }
    else if (this.resultStringArray[this.resultStringArray.length - 7] == '35' && this.resultStringArray[this.resultStringArray.length - 10] == '91') {
      this.ngZone.run(() => {

        this.voltage_B = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
          (this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 4], '33'))[1] +
          '.' + this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 4], '33')[0];
      });
      console.log('ywd:' + this.voltage_A);
    }
    else if (this.resultStringArray[this.resultStringArray.length - 7] == '36' && this.resultStringArray[this.resultStringArray.length - 10] == '91') {
      this.ngZone.run(() => {

        this.voltage_C = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
          (this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 4], '33'))[1] +
          '.' + this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 4], '33')[0];
      });
    }
    else if (this.resultStringArray[this.resultStringArray.length - 11] == '32' && this.resultStringArray[this.resultStringArray.length - 14] == '91') {

      const tempreading_A = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 7], '33') +
        (this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 8], '33'))[0] +
        '.' + this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 8], '33')[1];

      const decimalreading_A = parseFloat(tempreading_A);
      this.listdata_A.push(decimalreading_A);

      if (this.resultStringArray[this.resultStringArray.length - 6] != '32') {
        const tempreading_B = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 5], '33') +
          (this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 6], '33'))[0] +
          '.' + this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 6], '33')[1];
  ...
  calculateCS() {
    this.cs4va = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + voltageA_string)).toUpperCase();
    this.cs4vb = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + voltageB_string)).toUpperCase();
    this.cs4vc = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + voltageC_string)).toUpperCase();

    this.readva = this.updatedRootaddress + voltageA_string + this.cs4va + '16';
    this.readvb = this.updatedRootaddress + voltageB_string + this.cs4vb + '16';
    this.readvc = this.updatedRootaddress + voltageC_string + this.cs4vc + '16';
