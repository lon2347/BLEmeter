...
const quard0 = "110433333833"
const quard1 = "110433333933"
const quard2 = "110433333A33"
const quard3 = "110433333B33"
...
export class QuadrantsPage implements OnInit, OnDestroy {
  ...
  onTemperatureChange(buffer: ArrayBuffer) {
    ...
    if (this.resultStringArray[10] == '33' &&
      ...
      this.resultStringArray[12] == '38' &&
      this.resultStringArray[13] == '33' &&
      this.resultStringArray[8] == '91') {

      this.ngZone.run(() => {
        this.quard0_value = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
      ...
      console.log('ywd:' + this.quard0_value);
    }
    else if (this.resultStringArray[10] == '33' &&
      this.resultStringArray[11] == '33' &&
      this.resultStringArray[12] == '39' &&
      this.resultStringArray[13] == '33' &&
      this.resultStringArray[8] == '91'
    ) {
      this.ngZone.run(() => {
        this.quard1_value = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
          this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 4], '33') +
          + this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 5], '33') +
          '.' + this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 6], '33');
      });
      console.log('ywd:' + this.quard1_value);
    }
    else if (this.resultStringArray[10] == '33' &&
      this.resultStringArray[11] == '33' &&
      this.resultStringArray[12] == '3a' &&
      this.resultStringArray[13] == '33' &&
      this.resultStringArray[8] == '91') {
      this.ngZone.run(() => {
        this.quard2_value = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
          this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 4], '33') +
          + this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 5], '33') +
          '.' + this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 6], '33');
      });
      console.log('ywd:' + this.quard2_value);
    }
    else if (this.resultStringArray[10] == '33' &&
      this.resultStringArray[11] == '33' &&
      this.resultStringArray[12] == '3b' &&
      this.resultStringArray[13] == '33' &&
      this.resultStringArray[8] == '91') {
      this.ngZone.run(() => {
        this.quard3_value = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
          this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 4], '33') +
          + this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 5], '33') +
          '.' + this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 6], '33');

      });
      console.log('ywd:' + this.quard3_value);
    }
  ...
  calculateCS() {
    ...
    this.cs4va = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + quard0)).toUpperCase();
    this.cs4vb = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + quard1)).toUpperCase();
    this.cs4vc = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + quard2)).toUpperCase();
    this.cs4vd = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + quard3)).toUpperCase();

    this.readva = this.updatedRootaddress + quard0 + this.cs4va + '16';
    this.readvb = this.updatedRootaddress + quard1 + this.cs4vb + '16';
    this.readvc = this.updatedRootaddress + quard2 + this.cs4vc + '16';
    this.readvd = this.updatedRootaddress + quard3 + this.cs4vd + '16';
