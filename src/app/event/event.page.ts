...
const poweroff_f = "110433334436"
const poweroff_t = "11043F334436"
const coveroff_f = "110433406336"
const coveroffrecord = "110434406336"
const faultaction_f = "110433336936"
const faultactionrecord = "110434336936"
...
export class EventPage implements OnInit, OnDestroy {
  ...
  t4poweroff: string;
  f4coveroff: string;
  r4coveroff_start: string;
  r4coveroff_end: string;
  f4faultaction: string;
  r4faultaction_start: string;
  r4faultaction_end: string;
  ...
  onTemperatureChange(buffer: ArrayBuffer) {
    ...
    if (this.resultStringArray[this.resultStringArray.length - 9] == '33' &&
      this.resultStringArray[this.resultStringArray.length - 8] == '33' &&
      this.resultStringArray[this.resultStringArray.length - 7] == '44' &&
      this.resultStringArray[this.resultStringArray.length - 6] == '36' &&
      this.resultStringArray[this.resultStringArray.length - 11] == '91') {

      this.ngZone.run(() => {
        this.f4poweroff = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
      ...
      console.log('ywd:' + this.f4poweroff);
    }
    else if (this.resultStringArray[this.resultStringArray.length - 9] == '3f' &&
      this.resultStringArray[this.resultStringArray.length - 8] == '33' &&
      this.resultStringArray[this.resultStringArray.length - 7] == '44' &&
      this.resultStringArray[this.resultStringArray.length - 6] == '36' &&
      this.resultStringArray[this.resultStringArray.length - 11] == '91'
      ...
      this.ngZone.run(() => {
        ...
        this.t4poweroff = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
          this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 4], '33') +
          this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 5], '33');
      });
      console.log('ywd:' + this.t4poweroff);
    }
    else if (this.resultStringArray[this.resultStringArray.length - 9] == '33' &&
      this.resultStringArray[this.resultStringArray.length - 8] == '40' &&
      this.resultStringArray[this.resultStringArray.length - 7] == '63' &&
      this.resultStringArray[this.resultStringArray.length - 6] == '36' &&
      this.resultStringArray[this.resultStringArray.length - 11] == '91') {
      this.ngZone.run(() => {

        this.f4coveroff = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
          this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 4], '33') +
          this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 5], '33');
      });
      console.log('ywd:' + this.f4coveroff);
    }
    else if (this.resultStringArray[this.resultStringArray.length - 9] == '33' &&
      this.resultStringArray[this.resultStringArray.length - 8] == '33' &&
      this.resultStringArray[this.resultStringArray.length - 7] == '69' &&
      this.resultStringArray[this.resultStringArray.length - 6] == '36' &&
      this.resultStringArray[this.resultStringArray.length - 11] == '91') {
      this.ngZone.run(() => {

        this.f4faultaction = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
          this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 4], '33') +
          this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 5], '33');
      });
      console.log('ywd:' + this.f4faultaction);
    }
    else if (this.resultStringArray[10] == '34' &&
      this.resultStringArray[11] == '40' &&
      this.resultStringArray[12] == '63' &&
      this.resultStringArray[13] == '36' &&
      this.resultStringArray[8] == '91') {
      this.ngZone.run(() => {

        this.r4coveroff_start = this.subtractHexValue(this.resultStringArray[19], '33') +
          '年' + this.subtractHexValue(this.resultStringArray[18], '33') + '月' +
          this.subtractHexValue(this.resultStringArray[17], '33') + '日' +
          this.subtractHexValue(this.resultStringArray[16], '33') + ':' +
          this.subtractHexValue(this.resultStringArray[15], '33') + ':' +
          this.subtractHexValue(this.resultStringArray[14], '33');
        this.r4coveroff_end = this.subtractHexValue(this.resultStringArray[25], '33') +
          '年' + this.subtractHexValue(this.resultStringArray[24], '33') + '月' +
          this.subtractHexValue(this.resultStringArray[23], '33') + '日' +
          this.subtractHexValue(this.resultStringArray[22], '33') + ':' +
          this.subtractHexValue(this.resultStringArray[21], '33') + ':' +
          this.subtractHexValue(this.resultStringArray[20], '33');

      });
      console.log('ywd:' + this.r4coveroff_start);

    }
    else if (this.resultStringArray[10] == '34' &&
      this.resultStringArray[11] == '33' &&
      this.resultStringArray[12] == '69' &&
      this.resultStringArray[13] == '36' &&
      this.resultStringArray[8] == '91') {
      this.ngZone.run(() => {

        this.r4faultaction_start = this.subtractHexValue(this.resultStringArray[19], '33') +
          '年' + this.subtractHexValue(this.resultStringArray[18], '33') + '月' +
          this.subtractHexValue(this.resultStringArray[17], '33') + '日' +
          this.subtractHexValue(this.resultStringArray[16], '33') + ':' +
          this.subtractHexValue(this.resultStringArray[15], '33') + ':' +
          this.subtractHexValue(this.resultStringArray[14], '33');
        this.r4faultaction_end = this.subtractHexValue(this.resultStringArray[25], '33') +
          '年' + this.subtractHexValue(this.resultStringArray[24], '33') + '月' +
          this.subtractHexValue(this.resultStringArray[23], '33') + '日' +
          this.subtractHexValue(this.resultStringArray[22], '33') + ':' +
          this.subtractHexValue(this.resultStringArray[21], '33') + ':' +
      ...
      console.log('ywd:' + this.r4faultaction_start);
  ...
  calculateCS() {
    this.cs4va = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + poweroff_f)).toUpperCase();
    this.cs4vb = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + poweroff_t)).toUpperCase();
    this.cs4vc = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + coveroff_f)).toUpperCase();
    this.cs4vd = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + faultaction_f)).toUpperCase();
    this.cs4ve = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + coveroffrecord)).toUpperCase();
    this.cs4vf = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + faultactionrecord)).toUpperCase();

    this.readva = this.updatedRootaddress + poweroff_f + this.cs4va + '16';
    this.readvb = this.updatedRootaddress + poweroff_t + this.cs4vb + '16';
    this.readvc = this.updatedRootaddress + coveroff_f + this.cs4vc + '16';
    this.readvd = this.updatedRootaddress + faultaction_f + this.cs4vd + '16';
    this.readve = this.updatedRootaddress + coveroffrecord + this.cs4ve + '16';
    this.readvf = this.updatedRootaddress + faultactionrecord + this.cs4vf + '16';
