...
const loadA_string = "110433343635"

const loadB_string = "110433353635"

const loadC_string = "110433363635"
...
export class LoadPage implements OnInit, OnDestroy {
  ...
  onTemperatureChange(buffer: ArrayBuffer) {
    ...
    if (this.resultStringArray[this.resultStringArray.length - 8] == '34' && this.resultStringArray[this.resultStringArray.length - 11] == '91') {
      if (this.resultStringArray[this.resultStringArray.length - 3] == '33' && this.resultStringArray[this.resultStringArray.length - 4] == '33' && this.resultStringArray[this.resultStringArray.length - 5] == '33') {
        ...
        this.ngZone.run(() => {
          this.load_A = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
      ...
      if (this.resultStringArray[this.resultStringArray.length - 3] == '33' && this.resultStringArray[this.resultStringArray.length - 4] == '33' && this.resultStringArray[this.resultStringArray.length - 5] == '33') {
        ...
        this.ngZone.run(() => {
          this.load_B = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
            '.' + this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 4], '33') +
            this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 5], '33');
        });
      }
      console.log('ywd:' + this.load_B);
    }
      ...
      if (this.resultStringArray[this.resultStringArray.length - 3] == '33' && this.resultStringArray[this.resultStringArray.length - 4] == '33' && this.resultStringArray[this.resultStringArray.length - 5] == '33') {
        ...
        this.ngZone.run(() => {
          this.load_C = this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 3], '33') +
            '.' + this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 4], '33') +
            this.subtractHexValue(this.resultStringArray[this.resultStringArray.length - 5], '33');
        });
      }
      console.log('ywd:' + this.load_C);
    }
  ...
  calculateCS() {
    this.cs4la = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + loadA_string)).toUpperCase();
    this.cs4lb = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + loadB_string)).toUpperCase();
    this.cs4lc = this.sumHexValuesAndKeep8Bits((this.updatedRootaddress + loadC_string)).toUpperCase();

    this.readla = this.updatedRootaddress + loadA_string + this.cs4la + '16';
    this.readlb = this.updatedRootaddress + loadB_string + this.cs4lb + '16';
    this.readlc = this.updatedRootaddress + loadC_string + this.cs4lc + '16';
